   ...
   <!-- menu tengah -->
	<div id="menu-tengah">
        ...
        <div id="bungkus">
				<?php
					$query = "SELECT * FROM berita_gambar a, sub_katagori b WHERE a.id_katagori=3 AND b.id_katagori=3 GROUP BY a.id_berita ORDER by b.id_katagori DESC";
